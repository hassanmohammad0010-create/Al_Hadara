...
class AddDoctorToClinicPage extends StatelessWidget {
  AddDoctorToClinicPage({super.key, required this.clinicId});
  final int clinicId;
  final AddDoctorToClinicController addDoctorToClinicController = Get.find();
  @override
