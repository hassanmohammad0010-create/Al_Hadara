...
import 'package:al_hadara/Service/Auth/Doctor_Complete_Information_Service.dart';
import 'package:al_hadara/View/OnBording/Doctor_OnBording/On_Bording_Doctor_View.dart';
import 'package:get/get.dart';

Future<String> doctorCompleteInformationFunction({
  required String name,
  required String sepcialization,
  ...
  if (await checkInternet()) {
    String response = await DoctorCompleteInformationService()
        .completeDoctorInformation(
